...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_BITCAST_TRANSFORMS_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_BITCAST_TRANSFORMS_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_BITCAST_TRANSFORMS_H_
